        ...
        <div className="space-y-4">
          ...
          <div className='flex gap-10'>
            <span>
              ...
              <label for="male" className="text-sm opacity-80">Male</label>
            </span>
            <span>
              <input type="radio" id="female" name="gender" value="Female" className='mr-2'/>
              <label for="female" className="text-sm opacity-80">Female</label>
            </span>
            <span>
              <input type="radio" id="other" name="gender" value="Other" className='mr-2'/>
              <label for="other" className="text-sm opacity-80">Other</label>
            </span>
            
          </div>

          <Link to='/' className="text-sm opacity-70 cursor-pointer hover:underline">
